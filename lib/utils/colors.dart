...
class AppColors{
  ...
  static final Color yellowColor = const Color(0xffe7c66d);
  static final Color bluecolor = const Color(0xff5388e0);
  static final Color green = const Color(0xff5388e0);
